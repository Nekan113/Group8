...
export default function ProfilePage() {
  ...
  const { depositModal, setDepositModal, depositAmount, setDepositAmount, depositAlert, depositLoading, subAlert, subLoading, handleDeposit, handleSubscribe } = useWallet(setProfile);
              ...
              <div className={`card p-6 ${profile.isPremium ? 'border-yellow-700/50 bg-yellow-900/10' : ''}`}>
                ...
                {profile.isPremium ? (
                  ...
                  <div>
                    ...
                    {profile.wallet < 10 && (
                      <Alert type="warning" message="Insufficient balance. Deposit at least $10 to subscribe." className="mb-3" />
                    )}
                    <Button
